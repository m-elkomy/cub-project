...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
                        ...
                        echo $GetCupFetch[Name].' - Add Match';
                        ?>
                        </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="SaveMatch.php" method="post">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
                                  ...
                                  <?
								$GetTeam = mysql_query("SELECT team.TeamID as TeamID,team.Name AS TeamName FROM `team` inner join cup_team on (team.TeamID = cup_team.TeamID and cup_team.CupID = $CupID) order by team.Name ASC");
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge " id="Round" name="Round" type="text" value="">
								</div>
							  </div>
							  ...
							  <div class="controls">
                                ...
                                <input type="time" class="input-xlarge " id="MatchTime" name="MatchTime" value="">
							  </div>
							</div>
                              
							  <div class="form-actions">
								<button type="submit" class="btn btn-primary">Save changes</button>
								<a href="cupschdule.php"><button class="btn">Cancel</button></a>
							  </div>
							</fieldset>
						  </form>
