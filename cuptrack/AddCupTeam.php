...
<head>
	<meta charset="utf-8">
	<title>Cup Track - Cup Team Manage</title>
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Add Cup Team</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="SaveCupTeam.php" method="post">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
                                  ...
                                  <?
								$GetTeam = mysql_query("SELECT team.TeamID as TeamID,team.Name AS TeamName FROM `team` left join cup_team on (team.TeamID = cup_team.TeamID and cup_team.CupID = $CupID) where cup_team.TeamID is NULL order by team.Name ASC");
